...
export function EquipmentStatusHero({ equipamento, acoes }: { equipamento: Equipamento; acoes?: ReactNode }) {
  return (
    <div className="rounded-card-hero border border-border bg-surface p-6 shadow-elevated">
      <p className="text-sm text-foreground-subtle">{ROTULO_TIPO[equipamento.tipo]}</p>
