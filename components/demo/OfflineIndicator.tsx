...
export function OfflineIndicator() {
  ...
  if (!estado.demo.offline) {
    return (
      <div className="flex items-center gap-1.5 px-4 py-1 text-xs text-neutral-500">
  ...
  return (
    ...
    >
      ...
      {pendentes > 0 && (
        <span className="inline-flex items-center rounded-pill bg-white/70 px-2.5 py-0.5 text-xs font-semibold">
